                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" rows="3"
                            class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none">{{ old('description', $hotel->description) }}</textarea>
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        @if($hotel->main_image)
                        <div class="mb-2">
                            <img src="{{ $hotel->main_image }}" alt="Current"
                                class="w-32 h-20 object-cover rounded-xl border border-slate-100">
                        </div>
                        @endif
